...
export default function SignUpPage() {
    ...
    const { signup, error: authError, isLoading, isAuthenticated } = useAuth();
                    ...
                    <main className="grid gap-8 lg:grid-cols-2 lg:items-center">
                        ...
                        <section className="max-w-xl">
                            <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 ring-1 ring-white/10">
                                ...
                                <span className="text-xs font-semibold tracking-wide text-white/80">Start free, upgrade anytime</span>
                            </div>

                            <h1 className="mt-6 text-3xl font-semibold tracking-tight sm:text-5xl">Create an account</h1>
                    ...
                    ✓
                        ...
                        <section className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur sm:p-8">
                            <form onSubmit={onSubmit} className="space-y-5">
                                ...
                                >
                                    {busy || isLoading ? "Creating account..." : "Create account"}
                                </button>
